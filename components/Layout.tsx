        ...
        return (
          <Head>
            ...
            <link
              ...
              sizes="180x180"
              href="/yokohamaN/apple-touch-icon.png"
            />
            <link
              rel="icon"
              type="image/png"
              sizes="32x32"
              href="/yokohamaN/favicon-32x32.png"
            />
            <link
              rel="icon"
              type="image/png"
              sizes="16x16"
              href="/yokohamaN/favicon-16x16.png"
            />
            <link rel="manifest" href="/yokohamaN/site.webmanifest" />
            <link
              rel="mask-icon"
              href="/yokohamaN/safari-pinned-tab.svg"
              color="#5bbad5"
            />
            <meta name="msapplication-TileColor" content="#1e5fa6" />
